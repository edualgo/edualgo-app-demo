...
class SyntaxHighlighterStyle {
  ...
  static SyntaxHighlighterStyle syntaxStyle() {
    return SyntaxHighlighterStyle(
      baseStyle: const TextStyle(color: Color(0xFFFFFFFF)),
      numberStyle: const TextStyle(color: Colors.purpleAccent),
      keywordStyle: const TextStyle(color: Colors.tealAccent),
...
class CodeSnippet extends SyntaxHighlighter {
  CodeSnippet([this._style]) {
    _spans = <_HighlightSpan>[];
    _style = SyntaxHighlighterStyle.syntaxStyle();
  }
...
enum _HighlightType { number, keyword, punctuation, klass, constant }
